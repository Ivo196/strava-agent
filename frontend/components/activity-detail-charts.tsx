    ...
    <div className="activity-charts" aria-label="Evolución de la carrera por distancia">
      <section className="detail-chart panel">
        ...
        <ResponsiveContainer width="100%" height={250}>
          <LineChart accessibilityLayer data={data} margin={{ top: 14, right: 8, bottom: 0, left: -12 }}>
            ...
            <Line type="monotone" dataKey="pace_min_km" stroke="var(--viz-series-1)" strokeWidth={2.5} dot={false} activeDot={{ r: 4 }} connectNulls isAnimationActive={false} />
          </LineChart>
        </ResponsiveContainer>
      </section>
      ...
      <section className="detail-chart panel">
        ...
        <ResponsiveContainer width="100%" height={250}>
          <LineChart accessibilityLayer data={data} margin={{ top: 14, right: 8, bottom: 0, left: -12 }}>
            ...
            <Line type="monotone" dataKey="heartrate" stroke="var(--viz-series-2)" strokeWidth={2.5} dot={false} activeDot={{ r: 4 }} connectNulls isAnimationActive={false} />
          </LineChart>
        </ResponsiveContainer>
      </section>
      ...
      <section className="detail-chart detail-chart-wide panel">
        ...
        <ResponsiveContainer width="100%" height={210}>
          <AreaChart accessibilityLayer data={data} margin={{ top: 14, right: 8, bottom: 0, left: -12 }}>
            ...
            <Area type="monotone" dataKey="altitude_m" stroke="var(--viz-series-1)" fill="url(#altitude-fill)" strokeWidth={2.5} connectNulls isAnimationActive={false} />
          </AreaChart>
        </ResponsiveContainer>
      </section>
    </div>
